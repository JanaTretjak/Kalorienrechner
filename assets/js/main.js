...
document.getElementById("button").addEventListener("click", () => {
    ...
    if (document.getElementById("weiblich").checked) {
        ...
        grundumsatz = 66.47 + (13.7 * gewicht.value) + (5 * größe.value) - (6.8 * alter.value)
    }
    document.getElementsByTagName("td")[1].innerHTML = grundumsatz.toFixed(0)
    document.getElementsByTagName("td")[2].innerHTML = (grundumsatz * 4.184).toFixed(0)
    document.getElementsByTagName("td")[4].innerHTML = (grundumsatz * index).toFixed(0)
    document.getElementsByTagName("td")[5].innerHTML = (grundumsatz * 4.184 * index).toFixed(0)
})
